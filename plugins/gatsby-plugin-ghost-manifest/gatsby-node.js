...
exports.onPostBuild = /*#__PURE__*/ (function () {
  var _ref2 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/ _regenerator.default.mark(function _callee(_ref, pluginOptions) {
          ...
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              ;(icon = pluginOptions.icon),
                (manifest = (0, _objectWithoutPropertiesLoose2.default)(pluginOptions, ['icon']))
              _context.next = 4
              ...
              if (icon !== undefined) {
                ...
                if (!doesIconExist(icon)) {
                  Promise.reject(
                    'icon (' +
                      icon +
                      ') does not exist as defined in gatsby-config.js. Make sure the file exists relative to the root of the site.',
                  )
                }
